...
namespace NZWalks.API.Controllers
{
    ...
    public class RegionsController : Controller
    {
        ...
        [HttpDelete]
        //[Route("{id:guid")] wont work with this
        ...
        [HttpPut]
        [Route("{id:guid}")]
        public async Task<IActionResult> UpdateRegionAync([FromRoute]Guid id, [FromBody] Models.DTO.UpdateRegionRequest updateRegionRequest)
        {
            ...
            */
            if (addRegionRequest.Population < 0)
            {
                ModelState.AddModelError(nameof(addRegionRequest.Population),
                    $"{nameof(addRegionRequest.Population)} cannot be less zero.");
            }
            ...
            */
            ...
            if (updateRegionRequest.Population < 0)
            {
                ModelState.AddModelError(nameof(updateRegionRequest.Population),
                    $"{nameof(updateRegionRequest.Population)} cannot be less zero.");
            }
            if (ModelState.ErrorCount > 0)
            {
                return false;
